                  ...
                  children: [
                    const Text('IMAGE FILE',
                        style: TextStyle(
                            ...
                            fontWeight: FontWeight.w800,
                            color: Color(0xFF8A9BB0))),
                    _buildMiniBadge('Analysing', const Color(0xFFE8F0FE),
                        const Color(0xFF1A56DB)),
                  ],
                ),
                const SizedBox(height: 8),
                const Text('Photo of scene at time of incident.',
                    style:
                        TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                const Text('12 Aug 2024, 14:22 \u2022 ID: IMG_0812_SAPS',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.picture_as_pdf,
                    color: Color(0xFFCC0000), size: 24),
              ),
              ...
              const Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('medical_report_signed.pdf',
                        style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 14)),
                    Text('1.2 MB \u2022 Document',
                        style:
                            TextStyle(fontSize: 11, color: Color(0xFF8A9BB0))),
                  ],
                ),
              ),
            ],
          ...
          Row(
            children: [
              _buildMiniBadge('Transcribed', const Color(0xFFE8F0FE),
                  const Color(0xFF1A56DB)),
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              ...
              border:
                  Border(left: BorderSide(color: Color(0xFF002366), width: 3)),
            ),
            child: const Text(
            ...
            children: [
              Expanded(
                child: OutlinedButton(
                  ...
                  child: const Text('Download',
                      style: TextStyle(color: Color(0xFF002366), fontSize: 12)),
                ),
              ),
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () {},
                  style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFF002366), elevation: 0),
                ...
                child: Column(
                  ...
                  children: [
                    Text('Video Evidence',
                        style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 14)),
                    Text('Video \u2022 0:45 duration',
                        style:
                            TextStyle(fontSize: 11, color: Color(0xFF8A9BB0))),
                  ],
                ),
              ),
              _buildMiniBadge('Processing', const Color(0xFFF3F4F6),
                  const Color(0xFF6B7280)),
            ],
          ),
          const SizedBox(height: 8),
          const Text('CCTV footage from street corner.',
    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text('Upload additional evidence',
              style: TextStyle(
                  fontSize: 13,
                  fontWeight: FontWeight.bold,
                  color: Color(0xFF4A5568))),
          Text('JPG, PDF, MP4 up to 50MB',
      ...
      child: DataTable(
        ...
        rows: [
          DataRow(cells: [
            ...
            DataCell(_buildMiniBadge('In Transit', const Color(0xFFE8F0FE),
                const Color(0xFF1A56DB))),
          ]),
          DataRow(cells: [
            ...
            DataCell(_buildMiniBadge(
                'Secured', const Color(0xFFD1FAE5), const Color(0xFF065F46))),
          ]),
          DataRow(cells: [
            ...
            DataCell(_buildMiniBadge(
                'Finalised', const Color(0xFFF3F4F6), const Color(0xFF6B7280))),
          ]),
        ],
      ),
    );
